...
<table>
  ...
  <tr>
    <td><code>TektonHub</code></td>
    <td>Configure the <a HREF="https://github.com/tektoncd/hub">Tekton Hub</a> component to be installed and managed.</td>
  </tr>
  <tr>
